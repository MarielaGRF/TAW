...
<head>
  ...
  <link rel="stylesheet" href="Views/plugins/colorpicker/bootstrap-colorpicker.min.css">
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand bg-white navbar-light border-bottom">
    ...
    <ul class="navbar-nav ml-auto">
      <li class="nav-item">
        <a class="nav-link"href="index.php?action=log_out"><i
...
<!-- bootstrap color picker -->
<script src="Views/plugins/colorpicker/bootstrap-colorpicker.min.js"></script>
<!-- bootstrap time picker -->
